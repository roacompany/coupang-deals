      ...
      <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
        {TRENDING_KEYWORDS.map((keyword, i) => (
          <a
            ...
            className="flex items-center gap-2 px-3 py-2 bg-white border border-gray-100 rounded-full text-sm text-gray-700 hover:border-blue-300 hover:text-blue-600 hover:bg-blue-50 transition-all whitespace-nowrap shrink-0"
          >
